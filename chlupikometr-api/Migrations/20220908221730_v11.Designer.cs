...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "family_user_kind", new[] { "parent", "babysitter", "child" });
            ...
            modelBuilder.Entity("Chlupikometr.Family.Entity.Family", b =>
                {
                    ...
                    b.HasIndex("CreatorId")
                        .HasDatabaseName("ix_family_creator_id");
            ...
            modelBuilder.Entity("Chlupikometr.Family.Entity.Family", b =>
                {
                    b.HasOne("Chlupikometr.User.Entity.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_family_user_creator_id");
            ...
            modelBuilder.Entity("Chlupikometr.Family.Entity.FamilyUser", b =>
                {
                    b.HasOne("Chlupikometr.Family.Entity.Family", "Family")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_family_users_family_family_id");
                    ...
                    b.HasOne("Chlupikometr.User.Entity.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_family_users_user_user_id");
